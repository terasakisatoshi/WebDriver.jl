...
# ╔═╡ cd02a510-0b01-4c14-9d12-622c40697b05
using PlutoUI
...
# ╔═╡ a05a2064-b7e8-4e5c-843e-2332c27f48f7
...
# ╔═╡ 81f21ea2-32de-4ee5-b17f-a5a8587ff89f
@bind i Select(eachindex(spans))

# ╔═╡ cdfa9944-168e-4bab-b640-117bebcea256
begin
	s = spans[i]
	extractpost(s)
end
...
manifest_format = "2.0"
project_hash = "8f89bd6530acf64a8966452d08f080ed3b5efee5"
